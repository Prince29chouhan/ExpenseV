...
function Login() {
  ...
  const [activeTab, setActiveTab] = useState("login"); // Changed to handle login and register
  ...
  const onSubmit = async (data) => {
    try {
      // Use the appropriate endpoint for login
    ...
    localStorage.setItem("User", JSON.stringify({ username, email, user_id }));
          ...
          <div className="shrink-0">
            <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="founder mb-8">
                ...
                <div
                  className={`FI-box for-investors justify-center ${activeTab === "signup" ? "live" : ""}`}
              ...
              <h1 className="text-white text-4xl font-Montserrat">Welcome to Expense Tracker!</h1>
              ...
              <div className="form-control mt-6 w-[100%]">
                <button className="bg-[#FFE344] login-btn hover:bg-[#f2d846] text-black">Login</button>
              </div>
              <div className="flex">
              ...
              <div>
                <span className="text-[#ffffff80] font-Montserrat">Don’t have an account?{" "}
                  <a href="/signup" className="font-Montserrat text-[#FFE344]">Sign up</a>
                </span>
              </div>
            </form>
          </div>
